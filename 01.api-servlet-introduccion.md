...
![01.png](assets/01-servlet/01.png)
...
![02.png](assets/01-servlet/02.png)
...
![03.png](assets/01-servlet/03.png)
...
![04.png](assets/01-servlet/04.png)
...
![05.png](assets/01-servlet/05.png)
...
> **📌 Nota**  
> Para saber cómo configurar el arranque de nuestra aplicación y que nos aparezcan estas opciones:
> `Run '01-web-app'` o `Debug '01-web-app'` podemos ir al archivo `README.md`, a su apartado
> [⚙️ Configurando el arranque de la aplicación en IntelliJ IDEA](README.md#-configurando-el-arranque-de-la-aplicación-en-intellij-idea)
> donde se muestra paso a paso la configuración.
...
![06.png](assets/01-servlet/06.png)
...
![07.png](assets/01-servlet/07.png)

El servlet lo lee y lo renderiza en el HTML de respuesta:

![08.png](assets/01-servlet/08.png)
...
![09.png](assets/01-servlet/09.png)
...
## ⚙️ Configurando arranque de la aplicación

Configuramos el arranque para esta nueva aplicación en `Edit Configurations...` de nuestro `IntelliJ IDEA`:

![10.png](assets/01-servlet/10.png)
